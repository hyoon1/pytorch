...
inline float maybe_dispatch_head_grouped_fwd(
    ...
    if (head_grouping::log_enabled()) {
        ...
        const ck_tile::index_t n_groups =
            ck_tile::integer_divide_ceil(num_heads, group_sz);
